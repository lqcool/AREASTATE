        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                scope: {
                    ...
                    onSelection: "&",
                    onNodeToggle: "&",
                    onSelfnontextmenu:"&",//新添加的功能（李桥）右键菜单
                    options: "=?",
                    orderBy: "@",
                    reverseOrder: "@",
                    filterExpression: "=?",
                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function( $scope, $templateCache, $interpolate, treeConfig ) {
                	...
                	$scope.selTextmenu = function(){
                		$scope.onSelfnontextmenu();
                	}
                	
                    function defaultIsLeaf(node) {
                        //return !node[$scope.options.nodeChildren] || node[$scope.options.nodeChildren].length === 0;
                    	/**
                    	 * 修改 2017年12月5日14:49:16 李桥 
                    	 * 使得所有建立的文件夹是文件夹的图标
                    	 */
                    	if(node.type=="file"){
                    		return true;
                    ...
                    if(!template) {
                        template =
                            ...
                            '</li>' +
                            '</ul>';
                        template += '<div id="menu" style="display:none"><ul>' +
                        '<li><a href="">OOOO</a></li>'+
                        '<li><a href="">OOOO</a></li>'+
                        '<li><a href="">OOOO</a></li>'+
                        '<li><a href="">OOOO</a></li>'+
        ...
        .directive("treeTransclude", function() {
            ...
            return function(scope, element, attrs) {  
                ...
                element.bind('contextmenu', function($event) { 
                	...
                	var y = (off.top - 30) + "px";
                	var x = (off.left - 50) + "px";
                	menu.css({"position": "absolute","display":"block","top":y,"left":x,"width":"66%",
                		"box-shadow": "rgb(51, 51, 51) 2px 2px 5px, rgb(36, 74, 77) 2px 2px 10px"});
